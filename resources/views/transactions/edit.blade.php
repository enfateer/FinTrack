    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <h1 class="h4 fw-bold text-dark mb-4">
                <i class="fas fa-edit me-2 text-primary"></i> Edit Transaksi
            </h1>
            ...
            <form method="POST" action="{{ route('transactions.update', $transaction->id) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" id="item_name" name="item_name" value="{{ old('item_name', $transaction->item_name) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" id="price" name="price" value="{{ old('price', $transaction->price) }}" step="0.01" min="0"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" id="quantity" name="quantity" value="{{ old('quantity', $transaction->quantity) }}" min="1"
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="notes" name="notes" rows="3"
                            class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $transaction->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
